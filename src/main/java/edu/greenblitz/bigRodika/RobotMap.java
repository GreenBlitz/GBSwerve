    ...
    public static class Limbo2 {
        ...
        public static class Chassis {
            ...
            public static class Modules {
                ...
                public static final int[] DRIVE_MOTOR_PORTS = {8, 9, 6, 3};
                public static final int[] ROTATION_MOTOR_PORTS = {7, 5, 1, 4};
            ...
            public static class SwerveModule {
                public static final double DRIVE_P = 0, DRIVE_I = 0, DRIVE_D = 0, ANGLE_P = 0.2, ANGLE_I = 0.000, ANGLE_D = 0.0, ANGLE_TOLERANCE = 0.01/*RAD*/;
