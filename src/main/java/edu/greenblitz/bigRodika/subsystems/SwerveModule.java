...
public class SwerveModule extends GBSubsystem {
	...
	private final AnalogInput angleEncoder; //TODO: improve me
...
//	private double time;
	...
	private final SparkEncoder angleEncoderSpark; // TODO: delete me, I was made for testing
	...
	SwerveModule(int ID) {
		...
		this.angleEncoderSpark = new SparkEncoder(new GearDependentValue<Double>(1.0, 1.0), rotationMotor);
...
//		t0 = System.currentTimeMillis();
	...
	public int getRawTicks() {
		return angleEncoderSpark.getRawTicks();
	}
